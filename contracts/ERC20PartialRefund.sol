...
contract ERC20PartialRefund is ERC20TokenSale {
    ...
    function sellBack(uint256 amountOfTokensInDcmls) payable external {
        require(address(this).balance >= amountOfTokensInDcmls*ETH_IN_WEI_REFUND_PER_1000_TOKENS / TOKENS_IN_DCMLS_PER_ETH_IN_WEI,"Not enough balance");
        require(address(msg.sender).balance >= amountOfTokensInDcmls, "Not enough tokens to sell");
        ...
        (bool success, ) = payable(msg.sender).call{value: amountOfTokensInDcmls*ETH_IN_WEI_REFUND_PER_1000_TOKENS / TOKENS_IN_DCMLS_PER_ETH_IN_WEI}("");
